...
def get_user_manage_keyboard(target_user_id: int, username: str = None, fallback_callback: bool = False) -> InlineKeyboardMarkup:
    ...
    if clean_username:
        ...
        builder.button(text="🗑 Bazadan O'chirish", callback_data=f"admin_deluser_{target_user_id}")
    else:
